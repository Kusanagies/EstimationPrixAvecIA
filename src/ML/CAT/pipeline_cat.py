...
# Pas besoin de la normalisation d'après claude pour le CatBoost
...
# ==========================================
# 6. ENTRAINEMENT ET EVALUATION DE CatBoost
# ==========================================
print("Etape 6/6 : Entrainement de l'algorithme CATBOOST...")

kf = KFold(n_splits=5,shuffle=True,random_state=42)
modele_cv = CatBoostRegressor(
